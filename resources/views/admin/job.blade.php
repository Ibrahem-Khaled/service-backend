                ...
                <li class="breadcrumb-item">
                    <div>
                        <button type="button" class="btn btn-info" data-toggle="modal" data-target="#exampleModal"
                            style="font-size: 18px; font-family:Amiri;line-height: 1.2;"><i class="fa fa-cogs"></i> -
                            Add New Service
                        </button>
                    </div>
                </li>
                        ...
                        <tbody>
                            @foreach ($services as $service)
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn @if ($service->active == 0) btn-primary @else btn-dark @endif btn-sm"
                                            href="{{ route('activeService', $service->id) }}">
                                            @if ($service->active == 0)
                                        ...
                                        <div class="modal fade" id="edit{{ $service->id }}" tabindex="-1"
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="{{ route('updateService', $service->id) }}"
                                        ...
                                        <div class="modal fade" id="delete{{ $service->id }}" tabindex="-1"
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLabel">Delete Service
                                                        </h5>
                                                        <button type="button" class="close" data-dismiss="modal"
                                                            aria-label="Close">
                                                            <span aria-hidden="true">&times;</span>
