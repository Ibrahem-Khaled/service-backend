                ...
                <ul class="nav navbar-nav side-menu" id="sidebarnav">
                    ...
                    <li>
                        <a href="{{ route('admin.users.index') }}">
                            <div class="pull-left"><i class="fa fa-users"></i><span class="right-nav-text">Users</span>
                            </div>
                            <div class="clearfix"></div>
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="{{ route('userReports') }}">
                            <div class="pull-left"><i class="fa fa-users"></i><span
                                    class="right-nav-text">userReports</span></div>
                            <div class="clearfix"></div>
                        </a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="{{ route('getGallery') }}">
                            <div class="pull-left"><i class="fa fa-picture-o"></i><span class="right-nav-text">Image
                                    Gallery</span></div>
                            <div class="clearfix"></div>
                        </a>
                    </li>
